# MIC v0.1.1 Reference Core

`mic_core.c` is the public C reference validator for MIC v0.1.1.
...
The current public core performs validation in `dry_run` mode and does not
